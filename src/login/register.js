...
class Register extends React.Component {
    ...
    submitClick = async (type, e) => {
        ...
        console.log('this.email:',this.email_val_checker);
        ...
        if(this.fnValidate()){
            ...
            console.log('fullEmail:',this.state.full_email);
            axios.post('http://localhost:8000/api/registerConfirm', {
            ...
            .then( response => {
                try {
                    ...
                    console.log('!length:',dupli_count.length);
                    //이메일이 중복된 경우
                    if(dupli_count.length != 0){
        ...
        this.fnSignInsert = async (type, e) => {
            ...
            console.log('is_Email:',this.email_val_checker);
                axios.post('http://localhost:8000/api/register', {
                    is_Email: this.email_val_checker+'@'+this.email2_val_checker,
                    is_Password: this.pwd_val_checker,
                    is_Name:this.name_val_checker,
                    is_Phone : this.phone1_val_checker
                })
                                    ...
                                    <div className="re_cnt ct2">
                                        <table className="table_ty1">
                                            <tr className="re_email">
                                                <th><p className="p_email">이메일</p></th>
                                                <td>
